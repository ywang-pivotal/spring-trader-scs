...
public class UserService {
	...
	public void createAccount(Account account) {
		...
		String status = restTemplate.postForObject( serviceProperties.getProtocol() +
                serviceProperties.getAccountService() + "/account/", account, String.class);
	...
	public Map<String,Object> login(AuthenticationRequest request){
		...
		Map<String,Object> result = (Map<String, Object>) restTemplate.postForObject( serviceProperties.getProtocol() +
                serviceProperties.getAccountService() + "/login/".toString(), request, Map.class);
		return result;
	}
	...
	public Account getAccount(String user) {
	    ...
	    Account account = restTemplate.getForObject( serviceProperties.getProtocol() +
                serviceProperties.getAccountService() + "/account/?name={user}", Account.class, user);
	...
	public void logout(String user) {
	    ...
	    ResponseEntity<?> response = restTemplate.getForEntity( serviceProperties.getProtocol() +
                serviceProperties.getAccountService() + "/logout/{user}", String.class, user);
